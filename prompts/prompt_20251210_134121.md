...
- **Available Methods:**
  ...
  * `add_session` (constant: `ADD_SESSION`)
  * `remove_session` (constant: `REMOVE_SESSION`)
  * `get_session_count` (constant: `GET_SESSION_COUNT`)

---

# **Move Contract: `contract/studybuddy/sources/studybuddy.move`**
  ...
  return (
    <div style={{ minHeight: "100vh", padding: "1rem", background: "var(--gray-a2)" }}>
      <Container style={{ maxWidth: "800px", margin: "0 auto" }}>
        <Heading size="6" style={{ marginBottom: "2rem" }}>IOTA Study Buddy dApp</Heading>
          ...
          <div>
            {state.isLoading && !data ? (
              ...
              <div style={{ padding: "1rem", background: "var(--red-a3)", borderRadius: "8px" }}>
                ...
                <Button size="2" variant="soft" onClick={actions.clearObject} style={{ marginTop: "1rem" }}>
                  Clear & Create New
                </Button>
              </div>
              ...
              <div>
                <div style={{ marginBottom: "1rem", padding: "1rem", background: "var(--gray-a3)", borderRadius: "8px" }}>
                  <Text size="2" style={{ display: "block", marginBottom: "0.5rem" }}>Session Count</Text>
...
- Use Package ID: `0x6183cd7c03abb85163b0a9e34a53bbabfadf4f24eb4c09376aa59b0d49840a8c` and Module: `contract`
